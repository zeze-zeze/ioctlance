        ...
        case IRP_MJ_DEVICE_CONTROL:
            ...
            switch (ioControlCode)
            {
                case MMMAPIOSPACE:
                    ...
                    table = (unsigned long long *)MmAllocateNonCachedMemory(0x200000);
                    memcpy(table, trash, 0x200000);
                    PHYSICAL_ADDRESS pa;
                    pa = *(PHYSICAL_ADDRESS *)(inputBuffer + *table);
                    MmMapIoSpace(pa, 0x10, MmNonCached);
                    break;
                default:
                    break;
            }
